...
void ATwoHandedWeapon::BeginPlay()
{
	...
	WeaponBox->OnComponentBeginOverlap.AddDynamic(this, &ATwoHandedWeapon::OnBoxOverlap);
}
...
void ATwoHandedWeapon::AttachMeshToSocket(USceneComponent* InParent, const FName& InSocketName)
{
...
void ATwoHandedWeapon::OnSphereEndOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
